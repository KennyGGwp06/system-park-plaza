...
export function ProductCatalogPage() {
  ...
  return <div className="space-y-5">
    ...
    <PageHeader eyebrow="Inventario · configuración" title="Insumos y unidades" description="Define una sola vez cómo compras y controlas cada producto: por kilos, litros, unidades, cajas o botellas." actions={<><Button variant="secondary" icon={Plus} onClick={() => setMasterMode("UNIT")}>Agregar unidad</Button><Button variant="secondary" icon={Plus} onClick={() => setMasterMode("CATEGORY")}>Agregar categoría</Button><Button icon={Plus} onClick={beginCreate}>Agregar insumo</Button></>} />
