...
export function App() {
  ...
  return (
    <div className={`customer-app ${screen === "welcome" ? "welcome-active" : ""}`}>
      ...
      {screen === "welcome" ? <ModernWelcome onCredential={() => { setIdentityDraft(initialIdentity); setIdentityNext("home"); go("identify"); }} onRecover={() => go("recover")} /> : null}
