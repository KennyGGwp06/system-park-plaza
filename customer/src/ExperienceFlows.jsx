  ...
  return (
    <main className="lodging-studio">
      <section className="lodging-studio-hero">
        <img ref={heroRef} src={roomImages[activeRoom?.type?.name] || roomImages.Suite} alt="Habitación Park Plaza"/>
