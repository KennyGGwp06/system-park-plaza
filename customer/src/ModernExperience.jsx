...
export function ModernWelcome({ onCredential, onRecover }) {
  ...
  return <main className="ppx-welcome">
    ...
    <section className="ppx-entry-panel" id="welcome-actions"><div className="ppx-entry-heading"><div><small>EXPERIENCIA PARK PLAZA</small><p>¿Cómo deseas comenzar?</p></div><span className="ppx-auto-label">Cambio automático · 3 s</span></div><Entry icon={CreditCard} title="Registrarme e iniciar" text="Crea tu acceso con formulario o Google" onClick={onCredential} primary/><Entry icon={ClipboardList} title="Recuperar mi reserva" text="Ingresa tu DNI y revisa tus accesos" onClick={onRecover}/></section>
  </main>;
}
